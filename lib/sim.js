...
export const TILE_TYPES = {
  ...
  // the derived biomes (two-octave terrain, validated in world.html).
  // Costs are DELIBERATELY neutral — pricing terrain (and water
  // impassability) is an open design decision; when it lands, RULES bumps.
  water: { move: 1, scout: 1 },
  beach: { move: 1, scout: 1 },
  marsh: { move: 1, scout: 1 },
  forest: { move: 1, scout: 1 },
  mountain: { move: 1, scout: 1 },
  cliff: { move: 1, scout: 1 },
  peak: { move: 1, scout: 1 }
}
