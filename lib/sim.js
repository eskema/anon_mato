...
export const RULES = 28 // replay-rules version (28: metal nodes 0.09→0.3 — the node layout shifts, so old gathers replay differently; and RULES 27's shape-is-the-level ladder) — bump on ANY change that alters what an old
