...
export const SCOUT_FRACTION = 0.2 // SCOUT costs this × base (1 at depth 2) — discovering is cheap; walking there is the commitment
...
export function createSim() {
  ...
  function reserveMap() {
    ...
    while (q.length) {
      ...
      const charge = stepChargeAt(cur) // stepping from a neighbour toward `cur` charges entering cur
      for (const n of walkNeighbors(cur)) {
