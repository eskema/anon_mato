...
export const SCHEMA = 1 // save format version — the shape of the serialized object
...
export function createSim() {
  ...
  const serialize = () => ({
    app: "anon&mato",
    schema: SCHEMA,
    world: { angle: SEED_ANGLE, rings: RINGS, rules: RULES },
  ...
  function hydrate(save) {
    ...
    if (w.angle !== SEED_ANGLE || w.rings !== RINGS) return { ok: false, reason: "world mismatch" }
