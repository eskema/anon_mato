...
// ── screen orientations ──────────────────────────────
// Forward/inverse axial↔pixel matrices + corner start-angle for the two hex
// orientations. Pointy corners sit at 60·i−30°, flat at 60·i. Pure constants:
// the sim derives its topology tables from these, the renderer its layout —
// so the two can never disagree.
const SQRT3 = Math.sqrt(3)
export const POINTY = { f: [SQRT3, SQRT3 / 2, 0, 1.5], b: [SQRT3 / 3, -1 / 3, 0, 2 / 3], startDeg: -30 }
export const FLAT = { f: [1.5, 0, SQRT3 / 2, SQRT3], b: [2 / 3, 0, -1 / 3, SQRT3 / 3], startDeg: 0 }

// Screen angle (radians) of an axial vector under orientation `o`.
export const screenAngle = (o, q, r) => Math.atan2(o.f[2] * q + o.f[3] * r, o.f[0] * q + o.f[1] * r)
