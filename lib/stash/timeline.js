// STASHED — no longer imported. The header clock was retired in favour of the
// sun-dial clock (render.js drawClock). Kept in case the stacked-scale bars or
// the play/stop replay button are wanted again. To revive: import createTimeline
// into render.js, call draw()/height()/playButton(), and rewire the status-line
// toggle + hitPlay in grid.js.
//
